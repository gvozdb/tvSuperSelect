...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('tvsuperselect_core_path', null, $modx->getOption('core_path') . 'components/tvsuperselect/') . 'model/';
            $modx->addPackage('tvsuperselect', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/tvsuperselect/model/schema/tvsuperselect.mysql.schema.xml';
